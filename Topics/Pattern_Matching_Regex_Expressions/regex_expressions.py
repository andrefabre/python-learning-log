...
# You can define your own character class using square brackets. For example, the 
...
# You can also use ranges of numbers using a hyphen. For example, the character
# class [a-zA-Z0-9] will match all lowercase letters, all uppercase letters, and numbers
...
# You can out a dollar sign at the end of the regex to indicate the string
