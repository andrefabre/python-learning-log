...
# Define a string containind letters, symbols and numbers
character_string = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!<=>?@[\\]^_`{|}~"

# Define the user interface
password_gen = Tk() # Tk() contains provisions to handle user events and widgets
password_gen.geometry("350x200") # Define the dimensions of the frame of the application in the format length x breadth
