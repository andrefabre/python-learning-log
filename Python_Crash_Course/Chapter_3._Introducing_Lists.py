...
#   You can add a new element at any position in a list by using the insert() method.
...
# #       You can remove an item from any position in a list using the delete statement IF you know its index
...
# #       Popping items from any position in a List - you can use pop() to remove an item from any position
# #       in a list by including the index of the item you want to remove in parentheses.
...
#       NOTE: The remove() method only deletes the first occurrence of the value you specify
...
#   You can sort a list in reverse alphabetical order by passing the argument reverse=True
#   sort(reverse=True)

# Sorting a list temporarily with the sorted() function
#   To maintain the original order of a list but present it in sorted order, you can use the sorted() function
#   The sorted() function can also accept a reverse=True argument if you want to display a list in 
#   reverse alphabetical order

# Printing a List in Reverse Order
#   To reverse the order of a list, you can use the reverse() method.
#   reverse() doesn't sore backward alphabetically; it simply reverse the order of the list
#   The reverse() method changes the order of a list permanently, but you can revert to the original
